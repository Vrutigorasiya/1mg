        ...
        <>
            <div className="container mx-auto">
                <div className="shadow-xl bg-white mt-7 mx-3 rounded-xl p-5 block md:flex lg:flex items-center justify-between">
                    <div className=" ">
                        <h5 className="text-lg font-medium"> Manufacturer product Create</h5>
                    </div>
                        ...
                        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <div className="flex items-center">
                                    ...
                                    <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Manufacturer Product upload</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <div className="shadow-xl bg-white mt-7 mx-3 rounded-xl p-5 ">
                        ...
                        <div className="lg:flex block gap-5">
                            <div className="w-full md:w-1/2 lg:w-1/2 mt-7 flex">
                                <label className="ms-1 text-sm font-medium text-dark-500 md:ms-2 dark:text-gray-400">Ratings & Reviews:-</label>
