            ...
            <div className="mx-auto w-full">
                ...
                <section className="mx-5 my-5 !overflow-hidden ">
                    <div className="!w-full border shadow bg-white rounded-md p-5 block">
                        ...
                        <div className="flex flex-col md:flex-row mt-4 justify-between items-start md:items-end space-y-4 md:space-y-0 md:space-x-4">
                            <form className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 w-full md:w-auto">
                                ...
                                <div className="w-full sm:w-72">
                                    ...
                                    <select
                                        id="categoryby"
                                        className="bg-gray-50 border border-gray-300-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        defaultValue=""
                                    >
                                        <option value="">None</option>
                            ...
                            <button className="w-full lg:w-40  md:w-40 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 text-base">
                                Create Product
                            </button>
                            </Link>
