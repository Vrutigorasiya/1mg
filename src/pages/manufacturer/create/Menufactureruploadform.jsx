    ...
    return (
        <div ref={eleemntref}>
            <section className="flex max-w-screen-2xl md:mx-7 lg:mx-10  mt-10  justify-between border p-5 rounded-xl shadow-xl">
                <div className="">
                    <h3 className="lg:text-lg sm:text-sm font-bold">Create Menufacture</h3>
                </div>
                <div>
                    <nav className="flex lg:me-5" aria-label="Breadcrumb">
                        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            <li className="inline-flex items-center">
                                <Link to="/dashboard" className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-green-600 dark:text-gray-400 dark:hover:text-white">
                            ...
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <Link to="/manufacturerlist" className="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">
                                        Menufacture List
                                    </Link>
                                </div>
                            </li>
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <Link to="/manufactureruploadform" className="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">
                                        Create Menufacture
                                    </Link>
                                </div>
                            </li>
            ...
            <section className="border shadow-xl rounded p-7  mx-10 my-10">
                <h3 className="text-2xl font-bold">Menufacture Details</h3>
                <div className=" mt-10">
                        ...
                        <div className="lg:flex md:flex gap-5 mt-4 ">
                            <div className="md:w-1/3 lg:w-1/3 w-full sm:block">
                                ...
                                <FormControl className="w-full">
                                    <Select value={selectedCountry} type="select" name="m_country" onChange={handleCountryChange} displayEmpty inputProps={{ "aria-label": "Without label" }} required>
                                        <MenuItem value="">
